...
export const ROUTES = [
  ...
  { path: "/faq", title: "Hal FAQ - AI Coding Loop Questions", h1: "Hal FAQ", description: "Answers to common questions about Hal, PRD-native development, supported engines, and reviewable AI-generated code.", pageType: "FAQ" },
  { path: "/glossary", title: "Hal Glossary - AI Coding Workflow Terms", h1: "AI coding workflow glossary", description: "Definitions for PRD-native development, agentic coding workflows, acceptance criteria, and reviewable AI coding loops.", pageType: "Glossary" },
